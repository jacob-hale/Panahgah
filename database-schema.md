...
**RULE:** Do not alter, add, or remove columns from this schema without explicit permission. When creating C# Entity models or TypeScript interfaces, they must match these definitions exactly.
